...
var
Ini, WebIni: TIniFile;
DestPath, DestFile, version,verstr, conStr,SourceFile, SrcFile : string;
EPG_DB : TAdoConnection;
//const
    ...
    if StrToInt(version) < StrToInt(frm_update.DDL.FieldValues['VERSION']) then
      begin
        ...
        if DownloadFile(SourceFile, DestFile) then
          begin
            ShowMessage('Aplikasi EPG - XTI Versi '+ verstr +' berhasil diperbaharui dengan versi '+ frm_update.DDL.FieldValues['VERSTR']);
